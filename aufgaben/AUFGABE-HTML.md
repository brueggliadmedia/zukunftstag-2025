...
## ✅ Aufgabe 1: HTML-Struktur erstellen
...
2. Füge **vor** dem `<main>` Tag einen `<header>` Bereich ein:
   ```html
   <header>
     <!-- Hier kommt später der Kopfbereich -->
   </header>
   ```
...
5. Füge **nach** dem `</main>` Tag einen `<footer>` Bereich ein:
   ```html
  </main>
...
- Ändere den Text in `<h1>` und `<p>` zu etwas, das dir gefällt!
- Füge noch mehr `<p>` Absätze hinzu

### 🎓 Was lernst du dabei?

- HTML-Tags und ihre Bedeutung
- Die Struktur einer HTML-Seite
- Wie man verschiedene Bereiche einer Webseite organisiert

---

## 📋 Nächste Aufgaben

- **Aufgabe 2:** Kommt bald... 😊
